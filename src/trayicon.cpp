...
TrayIcon::TrayIcon() {
    ...
    setVisible(QSettings(qApp->applicationName(), qApp->applicationName()).value(CFG_SHOWTRAY, DEF_SHOWTRAY).toBool());
...
void TrayIcon::setVisible(bool enable) {
    QSettings(qApp->applicationName(), qApp->applicationName()).setValue(CFG_SHOWTRAY, enable);
